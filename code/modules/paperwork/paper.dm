...
/obj/item/weapon/paper/candy
	name = "Note"
	info = "Hey who ever's been stealing candy from the vending machine I swear to got I'm gonna' get sec on you so fast<BR> - Jan from engineering"
