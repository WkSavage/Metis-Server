/obj/item/weapon/reagent_containers/chem_disp_cartridge
	...
	ketoprofen	spawn_reagent = "ketoprofen"
	oxycodone	spawn_reagent = "oxycodone"
	norsodine	spawn_reagent = "norsodine"
	sterilizine	spawn_reagent = "sterilizine"
	leporazine	spawn_reagent = "leporazine"
	kelotane	spawn_reagent = "kelotane"
	osmotrol	spawn_reagent = "osmotrol"
	hexadrol/small	volume = CARTRIDGE_VOLUME_SMALL // For the medicine cartridge crate, so it's not too easy to get large amounts of dexalin
	hexadrol	spawn_reagent = "hexadrol"
	provo		spawn_reagent = "provolanaproxalidamine"
	cedilanid	spawn_reagent = "cedilanid"
