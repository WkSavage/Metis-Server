...
/datum/chemical_reaction/norsodine //T4
	...
	id = "norsodine"
	result = "norsodine"
	required_reagents = list("ketoprofen" = 1, "oxycodone" = 3)
	mix_message = "The mixture yields a pink liquid."
	result_amount = 2
	catalysts = list("react_a" = 1)
	log_is_important = 1

/datum/chemical_reaction/morphine //T5 Special
	name = "Morphine"
	id = "morphine"
	result = "morphine"
...
/datum/chemical_reaction/oxymorphine //T6 Special (Hidden Recipe)
	name = "Oxymorphine"
	id = "oxymorphine"
	result = "oxymorphine"
	required_reagents = list("morphine" = 2, "oxycodone" = 1, "epinephrine" = 1, "modafinil" = 1)
	mix_message = "The mixture yields a strong bubbling pink liquid."
	result_amount = 3
	catalysts = list("react_c" = 1)
	log_is_important = 1
...
/datum/chemical_reaction/dermalopein //T4
	...
	id = "dermalopein"
	result = "dermalopein"
	required_reagents = list("neodextraminesolution" = 3, "cedilanid" = 1, "acetic_acid" = 1)
	result_amount = 2
	log_is_important = 1
...
/datum/chemical_reaction/aqem //T4
	name = "Alprazaline Quint-Ethyl Metacetamin"
	id = "aqem"
	result = "aqem"
	required_reagents = list("hqem" = 1, "amytal" = 1, "pamelor" = 1, "demerol" = 1, "ibuprofen" = 1)
	result_amount = 2
...
/datum/chemical_reaction/epinephrine  //T3
	...
	id = "epinephrine"
	result = "epinephrine"
	required_reagents = list("modafinil" = 1, "hyperzine" = 1, "sugar" = 1)
	result_amount = 2
...
/datum/chemical_reaction/oxycodan_hexadro //T5 Special
	...
	required_reagents = list("hexadrol" = 3, "isoprovalyn" = 1, "oxygen" = 1, "modafinil" = 1)
	result_amount = 1
	log_is_important = 1
...
/datum/chemical_reaction/asinolyathin //T2
 ...
 /datum/chemical_reaction/dramacline //T3
	...
	id = "dramacline"
	result = "dramacline"
	required_reagents = list("asinolyathin" = 1, "kelotane" = 1, "hyperzine" = 1)
	result_amount = 2
...
/datum/chemical_reaction/ethylredoxrazine
	...
	required_reagents = list("cedilanid" = 1, "zinc_hydroxide" = 1, "carbon" = 1)
	result_amount = 3
...
/datum/chemical_reaction/leporazine
	...
	id = "leporazine"
	result = "leporazine"
	required_reagents = list("silicon" = 1, "copper" = 1, "methanol" = 1)
	catalysts = list("react_a" = 1)
	result_amount = 3
	log_is_important = 1
...
/datum/chemical_reaction/sterilizine
	...
	id = "sterilizine"
	result = "sterilizine"
	required_reagents = list("ethanol" = 1, "spaceacillin" = 1, "chlorine" = 1)
	result_amount = 3
...
/datum/chemical_reaction/ryetalyn
	...
	id = "ryetalyn"
	result = "ryetalyn"
	required_reagents = list("crystodigin" = 1, "cedilanid " = 1)
	catalysts = list("react_b" = 1)
	result_amount = 2
...
/datum/chemical_reaction/peridaxon
	...
	id = "peridaxon"
	result = "peridaxon"
	required_reagents = list("provolanaproxalidamine" = 2, "clonexadone" = 2)
	catalysts = list("react_c" = 1)
	result_amount = 2
...
/datum/chemical_reaction/imidazoline
	...
	id = "imidazoline"
	result = "imidazoline"
	required_reagents = list("iodine" = 1, "cedilanid" = 1)
	result_amount = 1
...
/datum/chemical_reaction/provolanaproxalidamine
	...
	required_reagents = list("ibuprofen" = 1, "demerol" = 1, "cedilanid" = 1, "kelotane" = 1, "phosphoric_acid" = 1)
	result_amount = 2
...
/datum/chemical_reaction/cryoxadone
	...
	id = "cryoxadone"
	result = "cryoxadone"
	required_reagents = list("hexadrol" = 1, "xenon" = 1, "calcium_hydroxide" = 1)
	result_amount = 3
...
/datum/chemical_reaction/clonexadone
	...
	id = "clonexadone"
	result = "clonexadone"
	required_reagents = list("cryoxadone" = 1, "epinephrine" = 1)
	catalysts = list("react_c" = 1)
	result_amount = 2
...
/datum/chemical_reaction/toxin
	...
	id = "toxin"
	result = "toxin"
	required_reagents = list("react_a" = 1, "react_b" = 1, "react_c" = 1)
	result_amount = 1
	log_is_important = 1
...
/datum/chemical_reaction/carpotoxin
	...
	id = "carpotoxin"
	result = "carpotoxin"
	required_reagents = list("toxin" = 1, "react_b" = 1, "radium" = 1)
	result_amount = 1
	log_is_important = 1
...
/datum/chemical_reaction/lipolicide
	...
	id = "lipolicide"
	result = "lipolicide"
	required_reagents = list("ammonia" = 1, "radium" = 1)
	result_amount = 1
...
/datum/chemical_reaction/itching_powder
	...
	required_reagents = list("lithium_hydroxide" = 1, "sodiumchloride" = 1, "kelotane" = 1)
	result_amount = 1
	log_is_important = 1
...
/datum/chemical_reaction/cyanide
	...
	id = "cyanide"
	result = "cyanide"
	required_reagents = list("toxin" = 1, "phoron" = 1, "soporific" = 1)
	result_amount = 1
...
/datum/chemical_reaction/soporific
	...
	id = "soporific"
	result = "soporific"
	required_reagents = list("chloralhydrate" = 1, "zinc_hydroxide" = 1, "water" = 4)
	result_amount = 3
	log_is_important = 1
...
/datum/chemical_reaction/chloralhydrate
	...
	required_reagents = list("chlorine" = 3, "alkysine" = 1, "carbolic_acid" = 1, "phosphoric_acid" = 1)
	result_amount = 3
	log_is_important = 1
...
/datum/chemical_reaction/pacid
	...
	id = "pacid"
	result = "pacid"
	required_reagents = list("sacid" = 1, "carbolic_acid" = 1, "acetic_acid" = 1, "citric_acid" = 1, "oxalic_acid" = 1, "phosphoric_acid" = 1)
	result_amount = 3
	log_is_important = 1
...
/datum/chemical_reaction/dimethyltryptamine
	...
	required_reagents = list("space_drugs" = 2, "coolant" = 1, "ethylredoxrazine" = 1, "carbolic_acid" = 1, "ammonia" = 1)
	result_amount = 3
...
/datum/chemical_reaction/cocaine
	...
	id = "cocaine"
	result = "cocaine"
	required_reagents = list("space_drugs" = 2, "dextroamphetamine" = 1, "citric_acid" = 1, "ketoprofen" = 1)
	result_amount = 3
...
/datum/chemical_reaction/ecstasy
	...
	id = "ecstasy"
	result = "ecstasy"
	required_reagents = list("space_drugs" = 1, "modafinil" = 1, "carbolic_acid" = 1, "lube" = 1)
	result_amount = 3
...
/datum/chemical_reaction/lsd
	...
	id = "lsd"
	result = "lsd"
	required_reagents = list("space_drugs" = 1, "chloralhydrate" = 1, "hydromel" = 1, "calcium_hydroxide" = 1)
	result_amount = 3
...
/datum/chemical_reaction/salvia
	...
	id = "salvia"
	result = "salvia"
	required_reagents = list("space_drugs" = 1, "sodiumchloride" = 1, "morphine" = 1, "tungsten" = 2)
	result_amount = 3
