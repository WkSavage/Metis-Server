...
/datum/seed/chili/ice/New()
	...
	set_trait(TRAIT_PRODUCT_ICON,"icechili")
...
/datum/seed/berry/glow/New()
	...
	set_trait(TRAIT_YIELD,2)
	set_trait(TRAIT_POTENCY,10)
	set_trait(TRAIT_PRODUCT_ICON,"glowberry")
...
/datum/seed/berry/poison/New()
	..()
	set_trait(TRAIT_PRODUCT_ICON,"poisonberry")
...
/datum/seed/berry/poison/death/New()
	...
	set_trait(TRAIT_PRODUCT_ICON,"deathberry")
...
/datum/seed/nettle/death/New()
	...
	set_trait(TRAIT_PRODUCT_ICON,"deathnettles")
...
/datum/seed/tomato/blood/New()
	..()
	set_trait(TRAIT_YIELD,3)
	set_trait(TRAIT_PRODUCT_ICON,"bloodtomato")
...
/datum/seed/tomato/killer/New()
	..()
	set_trait(TRAIT_YIELD,2)
	set_trait(TRAIT_PRODUCT_ICON,"killertomato")
...
/datum/seed/tomato/blue/New()
	..()
	set_trait(TRAIT_PRODUCT_ICON,"bluetomato")
...
/datum/seed/apple/gold/New()
	...
	set_trait(TRAIT_YIELD,3)
	set_trait(TRAIT_PRODUCT_ICON,"goldapple")
...
/datum/seed/ambrosia
	...
	chems = list("nutriment" = list(1), "space_drugs" = list(1,8), "kelotane" = list(1,8,1), "pamelor" = list(1,10,1), "toxin" = list(1,10))
...
/datum/seed/ambrosia/deus
	...
	mutants = null
	chems = list("nutriment" = list(1), "pamelor" = list(1,8), "hyperzine" = list(1,10,1), "space_drugs" = list(1,10))
	kitchen_tag = "ambrosiadeus"

/datum/seed/ambrosia/deus/New()
	..()
	set_trait(TRAIT_PRODUCT_ICON,"ambrosiadeus")
...
/datum/seed/flower/poppy
	...
	chems = list("nutriment" = list(1,20), "pamelor" = list(1,10))
	kitchen_tag = "poppy"
...
/datum/seed/grapes/green/New()
	..()
	set_trait(TRAIT_PRODUCT_ICON,"greengrapes")
...
/datum/seed/peanuts/New()
	...
	set_trait(TRAIT_YIELD,6)
	set_trait(TRAIT_POTENCY,10)
	set_trait(TRAIT_PRODUCT_ICON,"penut")
...
/datum/seed/whitebeets/New()
	...
	set_trait(TRAIT_YIELD,6)
	set_trait(TRAIT_POTENCY,10)
	set_trait(TRAIT_PRODUCT_ICON,"beet")
...
/datum/seed/citrus/New()
	...
	set_trait(TRAIT_YIELD,4)
	set_trait(TRAIT_POTENCY,15)
	set_trait(TRAIT_PRODUCT_ICON,"lime")
...
/datum/seed/kudzu/New()
	...
	set_trait(TRAIT_PRODUCT_ICON,"kudzu")
