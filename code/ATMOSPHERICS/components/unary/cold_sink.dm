...
/obj/machinery/atmospherics/unary/freezer
	...
	var/max_power_rating = 15000	// Power rating when the usage is turned up to 100
...
/obj/machinery/atmospherics/unary/freezer/engine
	...
	max_temp = 1600
	min_temp =0
	heat_transfer_coeffecient = 1.25
	max_power_rating = 20000
...
/obj/machinery/atmospherics/unary/freezer/cryogenics
	...
	max_power_rating = 25000

/obj/machinery/atmospherics/unary/freezer/lowpower
	name = "low power gas cooling system"
	set_temperature = 255
	min_temp =48
	heat_transfer_coeffecient = 0.25
	max_power_rating = 9000
